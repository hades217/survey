const { surveyResponseSchema, surveyCreateSchema, surveyUpdateSchema } = require('../schemas/surveySchemas');
const { saveSurveyResponse, getSurveyResponses, getSurveyStatistics } = require('../services/surveyService');
