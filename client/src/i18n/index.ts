	...
	en: {
		translation: {
			...
			survey: {
				...
				createFirst: 'Create your first survey to get started.',
				searchPlaceholder: 'Search surveys by title...',
				showing: 'Showing',
				of: 'of',
				surveys: 'surveys',
				noResults: 'No surveys match your filters.',
				view: {
					cards: 'Cards',
					list: 'List',
				},
	...
	zh: {
		translation: {
			...
			survey: {
				...
				error: '错误',
				noSurveys: '暂无问卷。',
				createFirst: '创建您的第一个问卷开始使用。',
				searchPlaceholder: '按标题搜索问卷...',
				showing: '显示',
				of: '共',
				surveys: '个问卷',
				noResults: '没有符合筛选条件的问卷。',
				view: {
					cards: '卡片',
					list: '列表',
				},
