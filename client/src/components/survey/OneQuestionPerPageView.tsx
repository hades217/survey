		...
		return (
			<div className="text-center py-8">
				...
				<p className="text-gray-500">
					{t('survey.oneQuestionPerPage.noQuestionsDescription', 'Please check back later.')}
				</p>
			</div>
		);
	}
		...
		<div className="space-y-8">
			...
			<div className="text-center mb-8">
				...
				<div className="text-sm text-[#767676]">
					{t('survey.oneQuestionPerPage.progressText', '{{current}} of {{total}} questions', {
			...
			{/* Question Content */}
			<div className={`bg-white rounded-2xl p-8 border border-[#EBEBEB] shadow-sm hover:shadow-md transition-shadow ${
				...
				{currentQuestion.descriptionImage && (
					<div className="mb-6">
						<img
							...
							alt={t('survey.oneQuestionPerPage.descriptionImage', 'Question illustration')}
							className="max-w-full h-auto rounded-lg border border-gray-300 mx-auto"
							onLoad={() => {
				...
				{currentQuestion.type === QUESTION_TYPE.SHORT_TEXT ? (
					<div className="space-y-4">
						<textarea
							...
							placeholder={t('survey.oneQuestionPerPage.textPlaceholder', 'Share your thoughts here...')}
							rows={6}
							value={currentAnswer}
								...
								>
									<div className="flex items-center justify-center relative">
										<input
											...
											value={optionValue}
											checked={isSelected}
											onChange={() => onAnswerChange(currentQuestion._id, optionValue)}
										/>
									...
									<div className="flex-1">
										{optionText && (
											<span className={`block text-lg leading-relaxed font-medium transition-colors ${
										...
										{optionImage && (
											<div className="mt-4">
												<img
													src={optionImage}
													alt={t('survey.oneQuestionPerPage.optionImage', 'Option {{number}}', {
														number: optIndex + 1,
													})}
					...
					<div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
						<div className="flex items-center gap-2 text-yellow-700">
							...
							<span className="text-sm font-medium">
								{t('survey.oneQuestionPerPage.answerRequired', 'Please provide an answer to continue.')}
							</span>
						</div>
					</div>
				)}
			...
			<div className="text-center text-sm text-[#767676]">
				{t('survey.oneQuestionPerPage.keyboardHint', 'Tip: Press Enter to proceed to the next question')}
			</div>
		</div>
	);
};
