						...
						<div className="flex">
							...
							<div className="ml-3">
								...
								<div className="mt-2 text-sm text-blue-700">
									<p>
										This contact information helps us provide better support and send important 
										updates about your account. We'll never share your information with third parties.
									</p>
								</div>
							</div>
						</div>
