			...
			<div className="bg-white rounded-lg shadow-lg p-8">
				<div className="space-y-8">
					...
					<div>
						...
						{/* Predefined Colors */}
						<div className="mb-4">
							<p className="text-sm text-gray-700 mb-2">Choose from popular colors:</p>
						...
						<div className="relative">
							<label htmlFor="themeColor" className="block text-sm text-gray-700 mb-2">
						...
						<div className="flex items-start space-x-3">
							<div className="flex-shrink-0">
								<input
									...
									onChange={(e) => handleInputChange('customLogoEnabled', e.target.checked)}
									className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
								/>
							</div>
							<div className="flex-1">
								<label htmlFor="customLogoEnabled" className="text-sm font-medium text-gray-900">
						...
						<div className="border border-gray-200 rounded-lg p-6 bg-gray-50">
							<div className="text-center">
								...
								<p className="text-sm text-gray-600 mt-4">
									This is how your survey buttons will look with the selected theme color
								</p>
							</div>
						</div>
					</div>
