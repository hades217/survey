		...
		<div className="max-w-2xl mx-auto">
			<div className="text-center mb-8">
				...
				<p className="text-gray-600">
					Configure default settings for your survey platform
				</p>
			...
			<div className="bg-white rounded-lg shadow-lg p-8">
				<div className="space-y-8">
					{/* Default Language */}
					<div>
						<label htmlFor="defaultLanguage" className="block text-sm font-medium text-gray-700 mb-4">
							Default Language
						</label>
						<div className="grid grid-cols-2 gap-3">
							{languageOptions.map((language) => (
								<button
									key={language.value}
									onClick={() => handleInputChange('defaultLanguage', language.value)}
						...
						<p className="text-sm text-gray-500 mt-2">
							This will be the default language for new surveys and system notifications
						</p>
					</div>
						...
						<div className="flex items-start space-x-3">
							<div className="flex-shrink-0 mt-1">
								<input
									...
									onChange={(e) => handleInputChange('autoNotifyCandidate', e.target.checked)}
									className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
								/>
							</div>
							<div className="flex-1">
								<label htmlFor="autoNotifyCandidate" className="text-sm font-medium text-gray-900">
									Automatically notify candidates
								</label>
								<p className="text-sm text-gray-500 mt-1">
									When enabled, candidates will automatically receive email notifications when:
								</p>
							...
							<div className="flex items-start space-x-3 p-4 bg-green-50 border border-green-200 rounded-lg">
								...
								<div>
									...
									<p className="text-sm text-green-700 mt-1">
										Start by creating a survey to test your setup and get familiar with the platform
									</p>
								</div>
							</div>
							...
							<div className="flex items-start space-x-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
								...
								<div>
									...
									<p className="text-sm text-blue-700 mt-1">
										Browse our pre-built question templates to speed up survey creation
									</p>
								</div>
							</div>
