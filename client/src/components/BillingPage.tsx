	...
	const renderFeatureList = (features: PlanFeatures) => (
		<ul className="space-y-3 text-sm">
			<li className="flex items-center">
				...
				<span>
					{features.maxSurveys === -1 ? 'Unlimited surveys' : `Up to ${features.maxSurveys} surveys`}
				</span>
			</li>
			<li className="flex items-center">
				<span className="mr-3 text-lg">❓</span>
				<span>
					{features.maxQuestionsPerSurvey === -1 ? 'Unlimited questions per survey' : `Up to ${features.maxQuestionsPerSurvey} questions per survey`}
				</span>
			</li>
			<li className="flex items-center">
				<span className="mr-3 text-lg">👥</span>
				<span>
					{features.maxInvitees === -1 ? 'Unlimited invitees' : `Up to ${features.maxInvitees} invitees`}
				</span>
			</li>
			<li className="flex items-center">
				<span className="mr-3 text-lg">{features.csvImport ? '✅' : '❌'}</span>
				<span className={features.csvImport ? '' : 'text-gray-500'}>
					CSV bulk import
				</span>
			</li>
			<li className="flex items-center">
			...
			<li className="flex items-center">
				...
				<span>
					{features.advancedAnalytics ? 'Advanced analytics & PDF export' : 'Basic analytics'}
				</span>
			</li>
			<li className="flex items-center">
			...
			<li className="flex items-center">
				<span className="mr-3 text-lg">📝</span>
				<span>
					{features.templates === -1 ? 'All survey templates' : `${features.templates} survey templates`}
				</span>
			</li>
		</ul>
	);
	...
	return (
		<div className="max-w-7xl mx-auto p-6">
					...
					<div className="flex">
						...
						<div className="ml-3">
							...
							<div className="mt-2 text-sm text-green-700">
								<p>Welcome to your new plan. You can now access all the features included in your subscription.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div className="flex">
						...
						<div className="ml-3">
							...
							<div className="mt-2 text-sm text-yellow-700">
								<p>No worries! You can try again anytime. Choose a plan below to get started.</p>
							</div>
						</div>
					</div>
				</div>
						...
						<div>
							...
							<div className="space-y-1">
								<p className="text-green-700">
									<span className="font-medium">Plan:</span> {subscriptionInfo?.subscriptionTier?.toUpperCase()} Plan
								</p>
								<p className="text-green-700">
									<span className="font-medium">Status:</span> {subscriptionInfo?.subscriptionStatus}
								</p>
								{getFormattedEndDate() && (
									<p className="text-green-700">
										<span className="font-medium">Next billing:</span> {getFormattedEndDate()}
									</p>
								)}
			...
			<div className="grid lg:grid-cols-2 gap-8 mb-8">
				{/* Basic Plan */}
				<div className={`relative border-2 rounded-xl p-8 ${
					...
					<div className="text-center mb-8">
						...
						<p className="text-gray-600 mt-2">Perfect for small teams and individuals</p>
					</div>
					
					<div className="mb-8">
						{renderFeatureList(PLAN_FEATURES.basic)}
					</div>
				...
				<div className={`relative border-2 rounded-xl p-8 ${
					...
					<div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
						<span className="bg-purple-500 text-white px-4 py-1 rounded-full text-sm font-medium">
							{subscriptionInfo?.subscriptionTier === 'pro' ? 'Current Plan' : 'Most Popular'}
						</span>
					</div>
					...
					<div className="mb-8">
						{renderFeatureList(PLAN_FEATURES.pro)}
					</div>
						...
						{subscriptionInfo?.subscriptionTier === 'pro' ? (
							...
							>
								{processingCheckout ? 'Processing...' : 
								 subscriptionInfo?.subscriptionTier === 'basic' ? 'Upgrade to Pro' : 'Start with Pro'}
							</button>
						)}
					</div>
				</div>
			...
			{!hasActiveSubscription && (
				<div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
					...
					<p className="text-yellow-700">
						You need an active subscription to use the survey platform. Please choose a plan above to get started.
					</p>
				</div>
			)}
			...
			<div className="mt-16">
				...
				<div className="grid md:grid-cols-2 gap-6">
					...
					<div className="bg-white p-6 rounded-lg border">
						...
						<p className="text-gray-600">You can cancel anytime and will retain access to your plan features until the end of your current billing period.</p>
					</div>
					<div className="bg-white p-6 rounded-lg border">
						<h3 className="font-semibold text-gray-900 mb-2">Is my data secure?</h3>
						<p className="text-gray-600">Yes, we use industry-standard encryption and security measures to protect your data and survey responses.</p>
					</div>
					<div className="bg-white p-6 rounded-lg border">
						<h3 className="font-semibold text-gray-900 mb-2">Do you offer refunds?</h3>
						<p className="text-gray-600">We offer a 30-day money-back guarantee for new subscriptions. Contact support for assistance.</p>
					</div>
				</div>
			</div>
		</div>
