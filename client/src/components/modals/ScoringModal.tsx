	...
	useEffect(() => {
		if (selectedSurvey?.scoringSettings) {
			setLocalScoring({
				...
				showScore: selectedSurvey.scoringSettings.showScore !== undefined ? selectedSurvey.scoringSettings.showScore : true,
				showCorrectAnswers: selectedSurvey.scoringSettings.showCorrectAnswers !== undefined ? selectedSurvey.scoringSettings.showCorrectAnswers : true,
				showScoreBreakdown: selectedSurvey.scoringSettings.showScoreBreakdown !== undefined ? selectedSurvey.scoringSettings.showScoreBreakdown : true,
				customScoringRules: {
