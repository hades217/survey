			...
			<div className="bg-white rounded-lg border border-gray-200 p-6">
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
					...
					<div className={`border-2 rounded-lg p-6 ${
						...
						<div className="mb-4">
							<h4 className="text-xl font-bold text-gray-900">{PLAN_DETAILS.basic.name}</h4>
							<div className="mt-2">
								<span className="text-3xl font-bold text-gray-900">${PLAN_DETAILS.basic.price}</span>
								<span className="text-gray-600">/月</span>
							</div>
							<p className="text-sm text-gray-600 mt-2">{PLAN_DETAILS.basic.description}</p>
						</div>
					...
					<div className={`border-2 rounded-lg p-6 relative ${
						...
						<div className="mb-4">
							<h4 className="text-xl font-bold text-gray-900">{PLAN_DETAILS.pro.name}</h4>
							<div className="mt-2">
								<span className="text-3xl font-bold text-gray-900">${PLAN_DETAILS.pro.price}</span>
								<span className="text-gray-600">/月</span>
							</div>
							<p className="text-sm text-gray-600 mt-2">{PLAN_DETAILS.pro.description}</p>
						</div>
						
						<div className="mb-6">
							{renderFeatureList(PLAN_DETAILS.pro.highlights)}
						</div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<div className="bg-white rounded-lg border border-gray-200 p-6">
					...
					<div className="space-y-4">
						<div>
							<h4 className="text-sm font-medium text-gray-900 mb-1">可以随时更改套餐吗？</h4>
							<p className="text-sm text-gray-600">
								是的，您可以随时升级或降级套餐。更改将按比例计费，并在下个计费周期生效。
							</p>
						</div>
						<div>
							<h4 className="text-sm font-medium text-gray-900 mb-1">取消订阅后会怎样？</h4>
							<p className="text-sm text-gray-600">
								您可以随时取消订阅，在当前计费周期结束前仍可使用所有功能。
							</p>
						</div>
						<div>
							<h4 className="text-sm font-medium text-gray-900 mb-1">数据安全如何保障？</h4>
							<p className="text-sm text-gray-600">
								我们使用行业标准的加密和安全措施来保护您的数据和调查回复。
							</p>
						</div>
						<div>
							<h4 className="text-sm font-medium text-gray-900 mb-1">是否提供退款？</h4>
							<p className="text-sm text-gray-600">
					...
					<div className="space-y-4">
						<div className="flex items-start">
							...
							<div className="ml-3">
								...
								<p className="text-sm text-gray-600">工作日 9:00-18:00 为您提供实时帮助</p>
							</div>
						</div>
