		...
		<div className="p-6">
			...
			<div className="space-y-4">
				{features.map(feature => {
					...
					return (
						<div key={feature.id} className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
							<div>
								<h3 className="font-medium text-gray-900">{feature.name}</h3>
								<p className="text-sm text-gray-600">需要 {feature.requiredPlan.toUpperCase()} 套餐</p>
							</div>
							
							<div className="flex items-center space-x-3">
								{hasAccess ? (
									<>
										<span className="text-green-600 text-sm font-medium">✓ 可用</span>
									...
									<>
										<span className="text-red-600 text-sm font-medium">✗ 需升级</span>
		...
		<div className="p-6">
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
				...
				<UsageCard
					...
					icon={<svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export {
	SurveyCreationWithFreeAccount,
	FeatureAccessExample,
	FreeAccountDashboard
};