    ...
    <div className="p-6">
      ...
      <div className="flex flex-wrap gap-4 mb-6 p-4 bg-gray-50 rounded-lg">
        ...
        >
          📄 Import CSV
          {!canAccessFeature('csvImport') && (
            <span className="ml-1 text-xs bg-orange-500 text-white px-1 rounded">Pro</span>
          )}
        </button>
      ...
      <div className="space-y-4">
        {/* Survey questions would be rendered here */}
      </div>
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center space-x-8">
            ...
            <div className="flex space-x-4">
              <a href="/surveys" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md">
                Surveys
              </a>
              <a href="/analytics" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md">
                Analytics
              </a>
              <a href="/billing" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md">
                Billing
              </a>
            </div>
          </div>
          ...
          {canAccessFeature('advancedAnalytics') ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                Get detailed insights with advanced charts, trend analysis, and PDF exports.
              </p>
              <button
                onClick={() => setShowUpgradePrompt(true)}
